...
private Connection connection=new ClsConexion().getConection();
    ...
    public void agregarProveedor(ClsEntidadProveedor Proveedor){
        try{
            ...
            statement.setString("pdni",Proveedor.getStrDniProveedor());
    ...
    public void modificarProveedor(String codigo,ClsEntidadProveedor proveedor_u){
        /*try{
        ...
        ClsEntidadProveedorHib proveedor = new ClsEntidadProveedorHib();
        proveedor.setIdProveedor(new Integer(codigo));
        proveedor.setNombre(proveedor_u.getStrNombreProveedor());
        proveedor.setRuc(proveedor_u.getStrRucProveedor());
        proveedor.setDni(proveedor_u.getStrDniProveedor());
        proveedor.setDireccion(proveedor_u.getStrDireccionProveedor());
        proveedor.setTelefono(proveedor_u.getStrTelefonoProveedor());
        proveedor.setCelular(proveedor_u.getStrCelularProveedor());
        proveedor.setEmail(proveedor_u.getStrEmailProveedor());
        proveedor.setCuenta1(proveedor_u.getStrCuenta1Proveedor());
        proveedor.setCuenta2(proveedor_u.getStrCuenta2Proveedor());
        proveedor.setEstado(proveedor_u.getStrEstadoProveedor());
        proveedor.setObsv(proveedor_u.getStrObsvProveedor());
