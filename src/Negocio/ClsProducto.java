...
private Connection connection=new ClsConexion().getConection();
    ...
    public void agregarProducto(ClsEntidadProducto Producto){
        try{
            ...
            statement.setString("pprecioventa2","");
    ...
    public ArrayList<ClsEntidadProducto> listarProducto(){
        ...
        try{
            ...
            while (resultSet.next()){
                ...
                //producto.setStrPrecioVentaProducto2(resultSet.getString("PrecioVenta2"));
                ...
                producto.setStrDescuentoProveedor(resultSet.getString("DescuentoProveedor"));
                producto.setStrDescuentoVenta(resultSet.getString("DescuentoVenta"));
