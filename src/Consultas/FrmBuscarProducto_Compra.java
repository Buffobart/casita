...
public class FrmBuscarProducto_Compra extends javax.swing.JInternalFrame {
    ...
    public FrmBuscarProducto_Compra(FrmCompra parent ) {
        this.parent = parent;
        initComponents();
        ...
        //--------------------PANEL - PRODUCTO----------------------------
        this.productos = this.productoDao.getAllProductos(false);
...
//-----------------------------------------------------------------------------------------------
    void actualizarTablaProducto(){
       ...
       //this.productos = this.productoDao.getAllProductos();
    ...
    private void tblProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProductoMouseClicked
        ...
        if (fila == -1){
            ...
            */
            ...
            this.parent.setSelectedProduct( this.productos.get(fila) );
