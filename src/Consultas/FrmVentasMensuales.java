...
//-----------------------------------------------------------------------------------------------
  ...
  void BuscarVenta(){
    ...
    private void initComponents() {
        ...
        ycAño_ini.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        ycAño_fin.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            report=JasperCompileManager.compileReport(new File("").getAbsolutePath()+ "/src/Reportes/RptVentaMensual.jrxml");
