...
String Total;
    ...
    private ClsEntidadProductoHib selectedProduct;
    
    private DecimalFormat formater = FrmPrincipal.getInstance().getDecimalFormater();
    private OperacionDaoImpl operacionDao = new OperacionDaoImpl();
    private CuentaDaoImpl cuentasDao = new CuentaDaoImpl();
...
void CalcularTotal(){
    ...
    void CalcularSubTotal(){
        ...
        simbolos.setDecimalSeparator('.');
        DecimalFormat formateador = new DecimalFormat("####.##",simbolos);        
        subtotal=Double.parseDouble(txtTotalCompra.getText())/1.16;
    ...
    private void initComponents() {
        ...
        chkOrdenCompra = new javax.swing.JCheckBox();
        ...
        jPanel2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 50, -1));
        ...
        jPanel2.add(btnBuscarProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 28, 40, 35));
        ...
        chkOrdenCompra.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        chkOrdenCompra.setSelected(true);
        chkOrdenCompra.setText("GENERAR ORDEN DE COMPRA AL GUARDAR");
        getContentPane().add(chkOrdenCompra);
        chkOrdenCompra.setBounds(10, 480, 300, 23);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setText("Cuenta:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(570, 480, 60, 15);
        ...
        cboCuentas.setBounds(640, 480, 150, 20);
    ...
    Consultas.FrmBuscarProducto_Compra producto= new Consultas.FrmBuscarProducto_Compra(this);
        ...
        if (result == JOptionPane.YES_OPTION) {
            if(accion.equals("Nuevo")){
                ...
                if(this.chkOrdenCompra.isSelected()){
                    try {
                        compras.generarOrdenDeCompra( this.idventa );
                    } catch (Exception ex) {
    ...
    private javax.swing.JCheckBox chkOrdenCompra;
    ...
    public void setSelectedProduct(ClsEntidadProductoHib producto) {
        this.selectedProduct = producto;
    }

    public void updateProductDetails() {
        
        String costo = this.formater.format(this.selectedProduct.getPrecioCosto().multiply(selectedProduct.getMoneda().getTipoCambio()));
        ...
        this.txtPrecioProducto.setText(costo);
